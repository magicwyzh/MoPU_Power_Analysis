...
//*        Library Name     : ts6n28hpcphvta768x17m8f (user specify : TS6N28HPCPHVTA768X17M8F) */
//*        Library Version  : 130a */
//*        Generated Time   : 2018/01/05, 11:07:23 */
//*************************************************************************** ** */
`resetall
`celldefine
...
module TS6N28HPCPHVTA768X17M8F
  (AA,
  D,
  WEB,CLKW,
  AB,
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "TS6N28HPCPHVTA768X17M8F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "TS6N28HPCPHVTA768X17M8F_fault.cde";
`endif
...
reg valid_d16, valid_d15, valid_d14, valid_d13, valid_d12, valid_d11, valid_d10, valid_d9, valid_d8, valid_d7, valid_d6, valid_d5, valid_d4, valid_d3, valid_d2, valid_d1, valid_d0;
reg valid_bw16, valid_bw15, valid_bw14, valid_bw13, valid_bw12, valid_bw11, valid_bw10, valid_bw9, valid_bw8, valid_bw7, valid_bw6, valid_bw5, valid_bw4, valid_bw3, valid_bw2, valid_bw1, valid_bw0;
...
TS6N28HPCPHVTA768X17M8F_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
*/
module TS6N28HPCPHVTA768X17M8F_Int_Array (D, BW, AW, EN, RDB, AR, Q);
