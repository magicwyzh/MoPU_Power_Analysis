...
//*        Library Name     : ts6n28hpcphvta2048x16m8s (user specify : TS6N28HPCPHVTA2048X16M8S) */
//*        Library Version  : 130a */
//*        Generated Time   : 2018/01/05, 11:07:36 */
//*************************************************************************** ** */
`resetall
`celldefine
...
module TS6N28HPCPHVTA2048X16M8S
  (AA,
  D,
  WEB,CLKW,
  AB,
...
TS6N28HPCPHVTA2048X16M8S_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
*/
module TS6N28HPCPHVTA2048X16M8S_Int_Array (D, BW, AW, EN, RDB, AR, Q);
