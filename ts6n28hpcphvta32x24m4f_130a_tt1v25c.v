...
//*        Library Name     : ts6n28hpcphvta32x24m4f (user specify : TS6N28HPCPHVTA32X24M4F) */
//*        Library Version  : 130a */
//*        Generated Time   : 2018/01/05, 11:07:10 */
//*************************************************************************** ** */
`resetall
`celldefine
`timescale 1ns/1ps
...
`ifdef TSMC_INITIALIZE_MEM
  parameter cdeFileInit  = "TS6N28HPCPHVTA32X24M4F_initial.cde";
`endif
`ifdef TSMC_INITIALIZE_FAULT
   parameter cdeFileFault = "TS6N28HPCPHVTA32X24M4F_fault.cde";
`endif
...
TS6N28HPCPHVTA32X24M4F_Int_Array #(1,1,W,N,M,MES_ALL) MX (.D({DL}),.BW({BWEBL}),
...
*/
module TS6N28HPCPHVTA32X24M4F_Int_Array (D, BW, AW, EN, RDB, AR, Q);
